local assets=
{
    Asset("ANIM", "anim/hat_nanachihat.zip"),
	Asset("ATLAS", "images/inventoryimages/nanachihat.xml")
}
...
local function OnUnequip(inst, owner) 
    if owner:HasTag("nanachi") then
        owner.AnimState:ClearOverrideBuild("nanachihair")
    end
...
local function fn()
    ...
    inst.components.inventoryitem.imagename = "nanachihat"
    inst.components.inventoryitem.atlasname = "images/inventoryimages/nanachihat.xml"
